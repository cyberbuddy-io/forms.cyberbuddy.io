...
function send_message() {
  ...
  if (bin == 1) {
    ...
    db.ref("cess-scavenger-hunt/").push({
      name1: name1.value,
      name2: name2.value,
      name3: name3.value,
      num : num.value,
...
function upload_check() {
  var usr = document.getElementById("name1");
  if (usr.value == "") {
...
function upload_file() {
  const ref = firebase.storage().ref("cess-scavenger-hunt/");
